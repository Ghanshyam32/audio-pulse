...
import com.ghanshyam.audiopulse.PlayerActivity
import com.ghanshyam.audiopulse.SongsListActivity
import com.ghanshyam.audiopulse.databinding.SongSectionBinding
...
class SectionSongListAdapter(private val songIdList: List<String>) :
    ...
    class MyViewHolder(private val binding: SongSectionBinding) :
...
//            binding.songTitle.text = songId
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding =
            SongSectionBinding.inflate(LayoutInflater.from(parent.context), parent, false)
